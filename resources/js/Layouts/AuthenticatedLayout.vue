                            ...
                            <div class="hidden sm:flex space-x-8 sm:-my-px sm:items-center sm:ml-10">
                                ...
                                <div class="ml-3 relative">
                                    <Dropdown align="right" width="48">
                                        ...
                                        <template #content>
                                           <DropdownLink :href="route('region')"> State/Region  </DropdownLink>
                                        <DropdownLink :href="route('district')"> District  </DropdownLink>
                                        <DropdownLink :href="route('township')"> Township  </DropdownLink>                                         
                                        </template>
                                    </Dropdown>
                                </div>
                            </div>
