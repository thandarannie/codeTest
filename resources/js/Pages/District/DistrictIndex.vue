    ...
    <AuthenticatedLayout>
        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">  
                ...
                <div class="relative overflow-x-auto">
                    ...
                    border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(c,i) in districts.data">
                                ...
                                <td class="text-left px-1 py-2 border border-gray-300">
                                    <div class="mt-2">
                                        <Link title="Edit" :href="route('district.edit',c.id)" class=" inline-flex text-sm bg-green-500 w-fit mr-3 hover:bg-green-700 text-white font-bold py-1 px-4 rounded">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                ...
                <Pagination class="mt-3" :links="props.districts.links"/>
            </div>
        </div>
    </AuthenticatedLayout>
</template>
