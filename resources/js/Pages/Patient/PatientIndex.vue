                ...
                <div>
                    <VueTable :headers="header" :data="data" :keys="keys" >
                        ...
                        <template #td="{ item }">
                            ...
                            <td class="flex">
                                <div class="mt-2">
                                    <Link title="Edit" :href="route('patient.edit',item.id)" class=" inline-flex text-sm bg-green-500 w-fit mr-3 hover:bg-green-700 text-white font-bold py-1 px-4 rounded">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
