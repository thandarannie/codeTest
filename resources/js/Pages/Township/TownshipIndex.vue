...
let districtsearch = ref(props.districtfilters.search);
...
watch(districtsearch, throttle((value) => {
    router.get(
        "/basic-data/township",
    ...
    <AuthenticatedLayout>
            ...
            <Modal :show="addNewPopUp" @close="addNewPopUp = false">
                ...
                px-2 rounded-md sm:h-auto h-[340px] sm:overflow-auto overflow-y-scroll" id="popup" v-show="addNewPopUp">
                        ...
                        <div class="flex justify-between items-center mb-6">
                            <h2 class="md:text-base font-medium text-md">Add New Township</h2>
        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">  
                <div class="flex inflex-flex">
                    ...
                    <div class="mx-0 relative md:w-1/3 w-1/3 mb-3">
                        ...
                        class="w-full px-5 py-2 block w-md text-gray-500 
                            ...
                            focus:border-blue-500 " placeholder="Search by Township Name"/>
                    
                    </div>
                    <div class="ml-12 relative md:w-1/3 w-1/3 mb-3">
                        <select v-model="districtsearch" class="w-full px-5 py-2 block w-md text-gray-500 
                            text-sm  border border-gray-400 bg-white
                            focus:ring-blue-500 rounded-xl focus:border-blue-500 " 
                            style="border-radius: 4px;border: 1px solid #ddd" required> 
                            <option value="" selected>Filter By District</option>  
                            <option v-for="c in districts" :value="c.id">
                                {{ c.name }}
                            </option>
                        </select>
                    </div>
                ...
                <div class="relative overflow-x-auto">
                    ...
                    border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(c,i) in townships.data">
                                ...
                                <td class="text-left px-1 py-2 border border-gray-300">
                                    <div class="mt-2">
                                        <Link title="Edit" :href="route('township.edit',c.id)" class=" inline-flex text-sm bg-green-500 w-fit mr-3 hover:bg-green-700 text-white font-bold py-1 px-4 rounded">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                ...
                <Pagination class="mt-3" :links="props.townships.links"/>
            </div>
